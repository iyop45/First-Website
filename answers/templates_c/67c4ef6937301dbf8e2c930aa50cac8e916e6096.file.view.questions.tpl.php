<?php /* Smarty version Smarty-3.1.16, created on 2014-12-16 01:27:34
         compiled from "/home/content/99/11499199/html/answers/templates/view.questions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:23985850653f426c08d2df5-48369885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67c4ef6937301dbf8e2c930aa50cac8e916e6096' => 
    array (
      0 => '/home/content/99/11499199/html/answers/templates/view.questions.tpl',
      1 => 1396807624,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '23985850653f426c08d2df5-48369885',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53f426c0c59c94_52003901',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_53f426c0c59c94_52003901')) {function content_53f426c0c59c94_52003901($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
title">Q & A</div><a style="float:left" class="flatBlue" href="#">Ask a question</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
directory_link"><a href="http://techberry.org/answers/">Root</a></div></li><?php  $_smarty_tpl->tpl_vars['question'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['question']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['questions']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['question']->key => $_smarty_tpl->tpl_vars['question']->value) {
$_smarty_tpl->tpl_vars['question']->_loop = true;
?><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list"><a href="http://techberry.org/answers/q=<?php echo $_smarty_tpl->tpl_vars['question']->value['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['question']->value['titleLink'];?>
"><div data-user="<?php echo $_smarty_tpl->tpl_vars['question']->value['username'];?>
" class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_bubble miniprofile" style="background-color:<?php echo $_smarty_tpl->tpl_vars['question']->value['color'];?>
"><img class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_icon" src="<?php echo $_smarty_tpl->tpl_vars['question']->value['avatar'];?>
" alt="<?php echo $_smarty_tpl->tpl_vars['question']->value['title'];?>
"/></div></a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_info"><a class="light" href="http://techberry.org/answers/q=<?php echo $_smarty_tpl->tpl_vars['question']->value['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['question']->value['titleLink'];?>
"><h2><?php echo ucfirst($_smarty_tpl->tpl_vars['question']->value['title']);?>
</h2></a><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_description"><?php echo $_smarty_tpl->tpl_vars['question']->value['content'];?>
...</p></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_stats"><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_box help" data-ot="This count is based on approximations"><span class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_value"><?php echo $_smarty_tpl->tpl_vars['question']->value['views'];?>
</span>Views</div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_box <?php if ($_smarty_tpl->tpl_vars['question']->value['answered']>0) {?>accepted<?php }?>"><span class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_value"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['question']->value['answers'])===null||$tmp==='' ? 0 : $tmp);?>
</span>Answers</div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_box"><span class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_value"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['question']->value['votes'])===null||$tmp==='' ? 0 : $tmp);?>
</span>Votes</div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_box"><span class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_value"><?php echo $_smarty_tpl->tpl_vars['question']->value['date'];?>
</span>Age</div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixQA');?>
list_box_action"><a href="#" class="flatRed">Flag</a></div></div></li><?php } ?></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
