<?php /* Smarty version Smarty-3.1.16, created on 2014-12-16 01:27:11
         compiled from "/home/content/99/11499199/html/templates/pages/platforms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:34667275053b86fd67ef553-05915614%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a883e13135c41cdd9acdba8ec74548bb4c337ac8' => 
    array (
      0 => '/home/content/99/11499199/html/templates/pages/platforms.tpl',
      1 => 1418665054,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '34667275053b86fd67ef553-05915614',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53b86fd69a1047_13215826',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_53b86fd69a1047_13215826')) {function content_53b86fd69a1047_13215826($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
light"><h2><a href="http://techberry.org/chat/">Shoutbox</a></h2></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
<?php echo $_smarty_tpl->getConfigVariable('subPrefixWrap');?>
"><a href="http://techberry.org/chat/"><img src="http://techberry.org/images/chat.png" width="32" height="32"></a><p>Talk to other users online in real-time</p></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
light"><h2><a href="http://techberry.org/docs/#!/users.php">API</a></h2></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
<?php echo $_smarty_tpl->getConfigVariable('subPrefixWrap');?>
" style="margin-bottom:50px"><a href="http://techberry.org/docs/#!/users.php"><img src="http://techberry.org/images/api.png" width="32" height="32"></a><p>For developers who want to manipulate and interact with our services</p></div><hr><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
unsupported"><h3 class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
sub-title">Unsupported</h3><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
sub-text">I simply lack the time to expand and develop on these platforms</p><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
light" style="margin: 20px 20px 10px 20px !important;"><h2><a href="http://techberry.org/answers/">Questions</a></h2></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixProducts');?>
<?php echo $_smarty_tpl->getConfigVariable('subPrefixWrap');?>
...
<?php echo $_smarty_tpl->getConfigVariable('subPrefixWrap');?>
" style="margin-bottom:50px"><a href="http://techberry.org/tutorials/"><img src="http://techberry.org/images/tuts.png" width="32" height="32"></a><p>Detailed tutorials for a wide variety of languages and computer tricks</p></div></div></div></div></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
