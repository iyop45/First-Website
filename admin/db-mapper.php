 ...
 */
if(!defined('externalAccess')) {
   die('Direct access not permitted');
}
require_once '../class.constants.php';
define('DB_HOST', \techberry\core\constants::ROOT_DBHOST);
define('DB_USER', \techberry\core\constants::ROOT_DBUSER);
define('DB_PASS', \techberry\core\constants::ROOT_DBPASS);
define('DB_NAME', \techberry\core\constants::ROOT_DBNAME); //change this if you only want one database to be graphable
