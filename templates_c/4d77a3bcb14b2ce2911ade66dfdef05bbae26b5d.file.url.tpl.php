<?php /* Smarty version Smarty-3.1.16, created on 2015-01-04 15:35:39
         compiled from "/home/content/99/11499199/html/templates/pages/url.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107722621453875341198434-25566289%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d77a3bcb14b2ce2911ade66dfdef05bbae26b5d' => 
    array (
      0 => '/home/content/99/11499199/html/templates/pages/url.tpl',
      1 => 1406828146,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '107722621453875341198434-25566289',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53875341388356_19225429',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_53875341388356_19225429')) {function content_53875341388356_19225429($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
title">External link</h2><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixSupport');?>
...
imageSide" src="http://techberry.org/images/internet-safari-icon.png"></div><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixAbout');?>
large">It should be noted that although we do try and moderate external links we still have no control over third party content. If you're uncertain please review the reports for this link: <a target="_blank" href="http://scanurl.net/?u=<?php echo $_smarty_tpl->tpl_vars['urlInfo']->value['scanUrl'];?>
&uesb=Check+This+URL#results" class="default">here</a></p><?php if ($_smarty_tpl->tpl_vars['urlInfo']->value['isBlackListed']) {?><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixAbout');?>
large color-red">This link has been recognised for violating our terms of service.</p><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixSupport');?>
urlActions"><a href="#" class="flatLocked">Locked</a><?php } else { ?><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixSupport');?>
urlActions"><a style="float:left" class="flatBlue" href="<?php echo $_smarty_tpl->tpl_vars['urlInfo']->value['url'];?>
">Follow</a><?php }?><a style="float:left" class="flatRed" href="javascript:history.back()">Cancel</a></div></div></div></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
