<?php /* Smarty version Smarty-3.1.16, created on 2014-02-25 11:03:43
         compiled from "/home/content/99/11499199/html/forum/templates/edit.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:550129183530cdaffb749d0-43928956%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '550129183530cdaffb749d0-43928956',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530cdaffe43ab2_18939326',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530cdaffe43ab2_18939326')) {function content_530cdaffe43ab2_18939326($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
info_message">We're not currently accepting any more edits as the queue is full. Check back soon.</div><?php }?><?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_editPost']) {?><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message">As you're <a href="#" class="default">new</a> your edits will be placed in a queue untill reviewed by a <a href="#" class="default">moderator</a></div><?php }?><select onchange="viewEdit(this.value)"><option value="" <?php if (!$_smarty_tpl->tpl_vars['show_edit']->value) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['postUsername']->value;?>
...
</div><?php } else { ?><input type="text" class="input_text" placeholder="Title" value="<?php echo $_smarty_tpl->tpl_vars['title']->value;?>
"/><textarea class="textarea" placeholder="Content"><?php echo $_smarty_tpl->tpl_vars['content']->value;?>
...
edit_button"><a class="flatBlue" href="#" <?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_commitPostEdit']) {?>onclick="q(); return false;"<?php }?>>Commit</a></li><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
edit_button"><a class="flatRed" href="#" <?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_flagPostEdit']) {?>onclick="q(); return false;"<?php }?>>Flag</a></li></ul></div></li></ul></div></div><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
