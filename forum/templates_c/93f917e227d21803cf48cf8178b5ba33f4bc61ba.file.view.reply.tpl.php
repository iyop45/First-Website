<?php /* Smarty version Smarty-3.1.16, created on 2014-05-14 01:58:34
         compiled from "/home/content/99/11499199/html/forum/templates/view.reply.tpl" */ ?>
<?php /*%%SmartyHeaderCode:84675813530b9110b4dbd3-17782230%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93f917e227d21803cf48cf8178b5ba33f4bc61ba' => 
    array (
      0 => '/home/content/99/11499199/html/forum/templates/view.reply.tpl',
      1 => 1392852126,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '84675813530b9110b4dbd3-17782230',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_530b9110d03578_74254377',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_530b9110d03578_74254377')) {function content_530b9110d03578_74254377($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
<head>
	...
	<script type="text/javascript">function im(u){$("#im").remove();document.cookie = 'im='+u+'; expires=0; path=/';document.body.innerHTML += '<iframe id="im" scrolling="no" src="http://techberry.org/frames/user.instant_messenger.php?token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
...
&username_to='+u+'"></iframe>';}$(function(){Opentip.styles.default = {showOn: 'mouseover',target: true,tipJoint: "bottom"};$('.miniprofile').each(function(i,obj){new Opentip(obj,{ style: "default", ajax:"http://techberry.org/frames/user.profile.php?username="+$(this).data('user') });});$('.tooltipWiki').each(function(i,obj){new Opentip(obj,{ style: "default", ajax:"http://techberry.org/frames/tooltip.wiki.php?explain="+$(this).data('v') });});});<?php if ($_smarty_tpl->tpl_vars['isLoggedIn']->value) {?>$(document).ready(function(){var u = getCookie('im');if(u){$('#toTop').css('bottom','3em');$('#toTop').css('right','1em');document.body.innerHTML += '<iframe id="im" style="bottom:-265px;" scrolling="no" src="http://techberry.org/frames/user.instant_messenger.php?token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
...
page" style="height:100%">reply view isn't quite there yet!</div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
?>var n = noty({text: '<?php echo $_smarty_tpl->tpl_vars['alert']->value[0];?>
',type: '<?php echo $_smarty_tpl->tpl_vars['alert']->value[1];?>
',layout: 'bottomLeft'});/*alertify.log("<?php echo $_smarty_tpl->tpl_vars['alert']->value[0];?>
