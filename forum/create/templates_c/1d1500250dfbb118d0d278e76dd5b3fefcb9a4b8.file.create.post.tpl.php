<?php /* Smarty version Smarty-3.1.16, created on 2014-12-08 19:52:08
         compiled from "/home/content/99/11499199/html/forum/templates/create.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1250022741531222cb3455e6-17466229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1250022741531222cb3455e6-17466229',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_531222cb585b43_13372748',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_531222cb585b43_13372748')) {function content_531222cb585b43_13372748($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
"});$('#notification_bell').unbind('click');});}}});}, 8000);});<?php }?></script>
</head>
...
title">Forums</div><a href="#" style="float:left" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_createPost']) {?>flatLocked strikethrough tooltipWiki pointsNeeded"data-action="forum_createPost"data-v="forum:post:create:lackPrivilege"<?php } else { ?>flatBlue"onclick="forum_createPost(); return false"<?php }?>>Submit</a><a style="float:left" class="flatRed" href="javascript:history.back()" data-ot="Go back">Cancel</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
/"><input name="title" type="text" class="input_text" placeholder="Title" maxlength="200"/><textarea name="content" class="textarea" placeholder="Content" maxlength="500"></textarea><input type="hidden" name="token" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
"/></form></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
side_tip"><h4>Links</h4><p><a href="http://techberry.org/help/bbcode" class="default" target="_blank">Forum rules »</a></p><p><a href="http://techberry.org/help/bbcode" class="default" target="_blank">BBCode docs »</a></p></div></li><?php } else { ?><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
list" style="margin-bottom:20px"><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
center_message">This topic simply doesn't exist</li><?php }?></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
