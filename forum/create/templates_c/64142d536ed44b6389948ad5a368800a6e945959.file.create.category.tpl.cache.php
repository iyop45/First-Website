<?php /* Smarty version Smarty-3.1.16, created on 2014-07-27 13:00:06
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_532961bf3099a6_30763011',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_532961bf3099a6_30763011')) {function content_532961bf3099a6_30763011($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
<?php echo $_smarty_tpl->getConfigVariable('subPrefixHeader');?>
_head_btn blue">Logout</button></a><div id="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
_header_block"><a class="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
_link" href="http://techberry.org/account/" style="margin-top:13px"><?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->tpl_vars[\'username\']->value;?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
</a><a class="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
_link" href="http://techberry.org/account/notifications/" onclick="notifications(); return false"><span id="notification_bell"></span></a><span style="height:25px" class="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
_avatar"><img src="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->tpl_vars[\'avatar\']->value;?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
" width="25px" height="25px"></span><div id="notifications" class="<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
_flyout" style="display:none"><div class="body-arrow"></div><div style="width:400px;height:327px;background-color:#e5e5e5;"><iframe id="notification_iframe" style="width:100%;height:100%" data-src="http://techberry.org/frames/user.notifications.php?token=<?php echo '/*%%SmartyNocache:899027404532961bf153da0-40548331%%*/<?php echo $_smarty_tpl->tpl_vars[\'token\']->value;?>
/*/%%SmartyNocache:899027404532961bf153da0-40548331%%*/';?>
...
title">Forums</div><a style="float:left" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_createCategory']) {?>flatLocked strikethrough tooltipWiki" onclick="q(); return false;" data-v="forum:category:create:lackPrivilege"<?php } else { ?>flatBlue" onclick="document.submit_new_category_form.submit();"<?php }?> href="#">Submit</a><a style="float:left" class="flatRed" href="javascript:history.back()">Cancel</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
info_message">You have insufficient privileges to create a category</div><?php }?><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
new_event" style="display:none" class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message"></div><form name="submit_new_category_form" method="post" action="http://techberry.org/forum/create/submit/c/"><input name="title" type="text" class="input_text" placeholder="Title"/><textarea name="content" class="textarea" placeholder="Description"></textarea><input type="hidden" name="token" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
"/></form></div></li></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
