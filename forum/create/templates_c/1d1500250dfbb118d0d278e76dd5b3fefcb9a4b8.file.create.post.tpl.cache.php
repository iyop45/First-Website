<?php /* Smarty version Smarty-3.1.16, created on 2014-07-09 18:43:50
         compiled from "/home/content/99/11499199/html/forum/templates/create.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16198628495331cb5da9fe69-42339377%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d1500250dfbb118d0d278e76dd5b3fefcb9a4b8' => 
    array (
      0 => '/home/content/99/11499199/html/forum/templates/create.post.tpl',
      1 => 1393708221,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16198628495331cb5da9fe69-42339377',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5331cb5dcbcd64_13093533',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_5331cb5dcbcd64_13093533')) {function content_5331cb5dcbcd64_13093533($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
<?php echo $_smarty_tpl->getConfigVariable('subPrefixHeader');?>
_head_btn blue">Logout</button></a><div id="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
_header_block"><a class="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
_link" href="http://techberry.org/account/" style="margin-top:13px"><?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->tpl_vars[\'username\']->value;?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
</a><a class="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
_link" href="http://techberry.org/account/notifications/" onclick="notifications(); return false"><span id="notification_bell"></span></a><span style="height:25px" class="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
_avatar"><img src="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->tpl_vars[\'avatar\']->value;?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
" width="25px" height="25px"></span><div id="notifications" class="<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'prefixGlobal\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->getConfigVariable(\'subPrefixUser\');?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
_flyout" style="display:none"><div class="body-arrow"></div><div style="width:400px;height:327px;background-color:#e5e5e5;"><iframe id="notification_iframe" style="width:100%;height:100%" data-src="http://techberry.org/frames/user.notifications.php?token=<?php echo '/*%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/<?php echo $_smarty_tpl->tpl_vars[\'token\']->value;?>
/*/%%SmartyNocache:16198628495331cb5da9fe69-42339377%%*/';?>
...
page" style="height:100%"><ul><?php if ($_smarty_tpl->tpl_vars['topicExists']->value==1) {?><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
list" style="margin-bottom:20px"><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
title">Forums</div><a style="float:left" class="flatBlue <?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_createPost']) {?>strikethrough<?php }?>" href="#" onclick="<?php if ($_smarty_tpl->tpl_vars['userPrivileges']->value['forum_createPost']) {?>document.submit_new_post_form.submit();<?php } else { ?>q(); return false;<?php }?>">Submit</a><a style="float:left" class="flatRed" href="javascript:history.back()">Cancel</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
</a></div>( Creating a post )</li><li><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
create_content"><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
new_event" style="display:none" class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message"></div><form name="submit_new_post_form" method="post" action="http://techberry.org/forum/create/submit/p=<?php echo $_smarty_tpl->tpl_vars['topic_id']->value;?>
/"><input name="title" type="text" class="input_text" placeholder="Title"/><textarea name="content" class="textarea" placeholder="Content"></textarea><input type="hidden" name="token" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
...
center_message">This topic simply doesn't exist</li><?php }?></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
