<?php /* Smarty version Smarty-3.1.16, created on 2014-12-18 15:00:14
         compiled from "/home/content/99/11499199/html/forum/templates/edit.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1775825305532963a3827060-50579772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c1076f68d199fd7faeee21804de1b43f1029ca1' => 
    array (
      0 => '/home/content/99/11499199/html/forum/templates/edit.post.tpl',
      1 => 1413591930,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1775825305532963a3827060-50579772',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_532963a3ae49f9_87208861',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_532963a3ae49f9_87208861')) {function content_532963a3ae49f9_87208861($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
page" style="height:100%"><script type="text/javascript">function viewEdit(id){window.location.replace("http://techberry.org/forum/edit/p=<?php echo $_smarty_tpl->tpl_vars['post_id']->value;?>
/"+id);}</script><ul><?php if ($_smarty_tpl->tpl_vars['postExists']->value==1) {?><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
list" style="margin-bottom:20px"><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
title">Forums</div><?php if (!$_smarty_tpl->tpl_vars['show_edit']->value) {?><a style="float:left" class="flatBlue" onclick="document.submit_edit_post_form.submit();" href="#">Save edit</a><?php }?><a style="float:left" class="flatRed" href="javascript:history.back()" data-ot="Go back">Cancel</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
info_message">We're not currently accepting any more edits as the <a href="#" class="default tooltipWiki" data-v="forum:post:edit:queue">queue</a> is full. Check back soon.</div><?php }?><?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_editPost']) {?><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message">As you're <a href="http://techberry.org/help/groups/new" data-v="user:new" class="default tooltipWiki">new</a> your edits will be placed in a queue until reviewed by a <a href="http://techberry.org/help/groups/moderator" data-v="user:moderator" class="default tooltipWiki">moderator</a></div><?php }?><select onchange="viewEdit(this.value)"><option value="" <?php if (!$_smarty_tpl->tpl_vars['show_edit']->value) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['postUsername']->value;?>
 ( <?php echo $_smarty_tpl->tpl_vars['postDate']->value;?>
...
</option><?php } ?><?php }?></select><?php if ($_smarty_tpl->tpl_vars['show_edit']->value) {?><div class="input_text" contenteditable="true"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</div><div class="textarea" contenteditable="true"><?php echo $_smarty_tpl->tpl_vars['content']->value;?>
</div><?php } else { ?><form name="submit_edit_post_form" method="post" action="http://techberry.org/forum/edit/submit/p=<?php echo $_smarty_tpl->tpl_vars['post_id']->value;?>
/"><input name="title" type="text" class="input_text" placeholder="Title" value="<?php echo $_smarty_tpl->tpl_vars['title']->value;?>
...
edit_button"><a href="http://techberry.org/forum/edit/publish/p=<?php echo $_smarty_tpl->tpl_vars['edit_id']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_commitPostEdit']) {?>strikethrough flatLocked tooltipWiki pointsNeeded" data-action="forum_editPost"  data-v="forum:post:edit:commit:lackPrivilege"<?php } else { ?>flatBlue"<?php }?>>Publish</a></li><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
edit_button"><a href="http://techberry.org/forum/edit/remove/p=<?php echo $_smarty_tpl->tpl_vars['edit_id']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_editPost']) {?>strikethrough flatLocked tooltipWiki pointsNeeded" data-action="forum_editPost"  data-v="forum:post:edit:lackPrivilege"<?php } else { ?>flatRed"<?php }?>>Remove</a></li></ul></div><?php }?></li><?php } else { ?><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
center_message">This post simply doesn't exist</li><?php }?></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
