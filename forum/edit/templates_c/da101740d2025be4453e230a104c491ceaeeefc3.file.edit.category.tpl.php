<?php /* Smarty version Smarty-3.1.16, created on 2014-12-15 11:48:52
         compiled from "/home/content/99/11499199/html/forum/templates/edit.category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:123751924053218a92afdfd7-91229839%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da101740d2025be4453e230a104c491ceaeeefc3' => 
    array (
      0 => '/home/content/99/11499199/html/forum/templates/edit.category.tpl',
      1 => 1413592161,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '123751924053218a92afdfd7-91229839',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53218a92eec6a8_04871500',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_53218a92eec6a8_04871500')) {function content_53218a92eec6a8_04871500($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
page" style="height:100%"><script type="text/javascript">function viewEdit(id){window.location.replace("http://techberry.org/forum/edit/c=<?php echo $_smarty_tpl->tpl_vars['category_id']->value;?>
...
title">Forums</div><?php if (!$_smarty_tpl->tpl_vars['show_edit']->value) {?><a style="float:left" class="flatBlue" onclick="document.submit_edit_category_form.submit();" href="#">Save edit</a><?php }?><a style="float:left" class="flatRed" href="javascript:history.back()">Cancel</a><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
/<?php echo $_smarty_tpl->tpl_vars['directory_categoryTitleLink']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['directory_categoryTitle']->value;?>
</a></div></li><?php if ($_smarty_tpl->tpl_vars['isLocked']->value==1) {?><li><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
edit_content"><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message">This category is locked and so edits can't be suggested or published</div></div></li><?php } else { ?><li><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
...
info_message">We're not currently accepting any more edits as the <a href="#" class="default tooltipWiki" data-v="forum:category:edit:queue">queue</a> is full. Check back soon.</div><?php }?><?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_editTopic']) {?><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
info_message">As you're <a href="http://techberry.org/help/groups/new" data-v="user:new" class="default tooltipWiki">new</a> your edits will be placed in a queue until reviewed by a <a href="http://techberry.org/help/groups/moderator" data-v="user:moderator" class="default tooltipWiki">moderator</a></div><?php }?><select onchange="viewEdit(this.value)"><option value="" <?php if (!$_smarty_tpl->tpl_vars['show_edit']->value) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['categoryUsername']->value;?>
 ( <?php echo $_smarty_tpl->tpl_vars['categoryDate']->value;?>
...
</option><?php } ?><?php }?></select><?php if ($_smarty_tpl->tpl_vars['show_edit']->value) {?><div class="input_text" contenteditable="true"><?php echo $_smarty_tpl->tpl_vars['categoryTitle']->value;?>
</div><div class="textarea" contenteditable="true"><?php echo $_smarty_tpl->tpl_vars['categoryDescription']->value;?>
</div><?php } else { ?><form name="submit_edit_category_form" method="post" action="http://techberry.org/forum/edit/submit/c=<?php echo $_smarty_tpl->tpl_vars['category_id']->value;?>
/"><input name="title" type="text" class="input_text" placeholder="Title" value="<?php echo $_smarty_tpl->tpl_vars['categoryTitle']->value;?>
"/><textarea name="content" class="textarea" placeholder="Content"><?php echo $_smarty_tpl->tpl_vars['categoryDescription']->value;?>
...
edit_button"><a href="http://techberry.org/forum/edit/publish/c=<?php echo $_smarty_tpl->tpl_vars['edit_id']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_commitCategoryEdit']) {?>strikethrough flatLocked tooltipWiki pointsNeeded" data-action="forum_editCategory" data-v="forum:category:edit:commit:lackPrivilege"<?php } else { ?>flatBlue"<?php }?>>Publish</a></li><li class="<?php echo $_smarty_tpl->getConfigVariable('prefixForum');?>
edit_button"><a href="http://techberry.org/forum/edit/remove/c=<?php echo $_smarty_tpl->tpl_vars['edit_id']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" class="<?php if (!$_smarty_tpl->tpl_vars['userPrivileges']->value['forum_editCategory']) {?>strikethrough flatLocked tooltipWiki pointsNeeded" data-action="forum_editCategory" data-v="forum:category:edit:lackPrivilege"<?php } else { ?>flatRed"<?php }?>>Remove</a></li></ul></div><?php }?></li><?php }?></ul></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
