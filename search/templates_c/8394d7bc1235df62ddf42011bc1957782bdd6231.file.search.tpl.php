<?php /* Smarty version Smarty-3.1.16, created on 2014-12-21 17:48:44
         compiled from "/home/content/99/11499199/html/templates/pages/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:413567243537523404aed43-50116106%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8394d7bc1235df62ddf42011bc1957782bdd6231' => 
    array (
      0 => '/home/content/99/11499199/html/templates/pages/search.tpl',
      1 => 1409072786,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '413567243537523404aed43-50116106',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5375234094c2b1_61278309',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_5375234094c2b1_61278309')) {function content_5375234094c2b1_61278309($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
page" style="height:100%"><!--<form id="<?php echo $_smarty_tpl->getConfigVariable('prefixGlobal');?>
search_form" style="top:0px" action="http://techberry.org/search/" method="get"><input type="text" name="query" id="<?php echo $_smarty_tpl->getConfigVariable('prefixGlobal');?>
search_input" size="40" value="<?php echo $_smarty_tpl->tpl_vars['query']->value;?>
" action="include/js_suggest/suggest.php" columns="2" autocomplete="off" delay="1500"/><input id="<?php echo $_smarty_tpl->getConfigVariable('prefixGlobal');?>
search_submit" style="top:3px;height:26px" type="submit" value=""/><input type="hidden" name="search" value="1"></form>--><script>(function() {var cx = '010847070576185715249:2nyivikkprw';var gcse = document.createElement('script');gcse.type = 'text/javascript';gcse.async = true;gcse.src = (document.location.protocol == 'https:' ? 'https:' : 'http:') +'//www.google.com/cse/cse.js?cx=' + cx;var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(gcse, s);})();</script><gcse:search></gcse:search><gcse:searchresults></gcse:searchresults></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
