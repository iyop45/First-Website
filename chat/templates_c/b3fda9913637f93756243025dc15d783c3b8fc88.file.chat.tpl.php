...
<?php /*%%SmartyHeaderCode:13666878285415ea43175ea0-45651975%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13666878285415ea43175ea0-45651975',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5415ea4343fa24_25573954',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_5415ea4343fa24_25573954')) {function content_5415ea4343fa24_25573954($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
side_note">Members in chat</p><div id="__onlineUsers"><?php  $_smarty_tpl->tpl_vars['user'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['user']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['onlineUsers']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['user']->key => $_smarty_tpl->tpl_vars['user']->value) {
$_smarty_tpl->tpl_vars['user']->_loop = true;
?><a id="user__<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
" href="http://techberry.org/user/<?php echo $_smarty_tpl->tpl_vars['user']->value['username'];?>
...
" style="float:left" height="32" width="32"/></a><?php } ?></div></div><?php } else { ?><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
active_users_list"><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
side_note">Members in chat</p><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
side_note" style="color: #666">This should not have happened</p></div><?php }?></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
...
"><textarea id="shoutmsg" name="shoutmsg"></textarea><input type="submit"value="Submit" class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
