<?php /* Smarty version Smarty-3.1.16, created on 2014-09-12 10:06:15
         compiled from "/home/content/99/11499199/html/templates/pages/chat.tpl" */ ?>
<?php /*%%SmartyHeaderCode:160594102353a821ca50e037-81938723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7318ca6e0a228cbb97741116dd1ca7abb6f541fb' => 
    array (
      0 => '/home/content/99/11499199/html/templates/pages/chat.tpl',
      1 => 1404158893,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '160594102353a821ca50e037-81938723',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53a821ca6f0eb8_93766417',
  'variables' => 
  array (
    'docType' => 0,
    'startOfHead' => 0,
...
<?php if ($_valid && !is_callable('content_53a821ca6f0eb8_93766417')) {function content_53a821ca6f0eb8_93766417($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
&username_to='+u+'"></iframe>';<?php } else { ?>window.location.href= "http://techberry.org/login?continue=<?php echo md5($_SERVER['PHP_SELF']);?>
...
"></iframe>';<?php } else { ?>window.location.href ="http://techberry.org/login?continue=<?php echo md5($_SERVER['PHP_SELF']);?>
...
<?php echo $_smarty_tpl->getConfigVariable('subPrefixHeader');?>
_head_btn blue">Logout</button></a><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixGlobal');?>
...
page" style="height:100%"><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
box"><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
recent_posts"><ul id="shout"><?php if ($_smarty_tpl->tpl_vars['shouts']->value) {?><?php  $_smarty_tpl->tpl_vars['shout'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['shout']->_loop = false;
...
?><li><div id="msg_<?php echo $_smarty_tpl->tpl_vars['shout']->value['id'];?>
" class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
message"><a href="http://techberry.org/user/<?php echo $_smarty_tpl->tpl_vars['shout']->value['username'];?>
/" class="miniprofile" data-user="<?php echo $_smarty_tpl->tpl_vars['shout']->value['username'];?>
"><span class="avatar <?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
avatar"><img title="<?php echo $_smarty_tpl->tpl_vars['shout']->value['username'];?>
" src="<?php echo $_smarty_tpl->tpl_vars['shout']->value['avatar'];?>
" width="25px" height="25px"></span></a><?php echo $_smarty_tpl->tpl_vars['shout']->value['message'];?>
</div></li><?php } ?><?php } else { ?><li><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
message">The chatbox is empty</div></li><?php }?></ul><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
garbageCollection">Garbage collection</p></div><?php if ($_smarty_tpl->tpl_vars['onlineUsers']->value) {?><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
active_users_list"><p class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
side_note">Members in chat</p><?php  $_smarty_tpl->tpl_vars['user'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['user']->_loop = false;
...
" style="float:left" height="32" width="32"/></a><?php } ?></div><?php } else { ?><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
side_bar">Welcome to TechBerry shoutbox, where you can talk about pretty much anything.</div><?php }?></div><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
form"><form id="shoutform" method="post" action="http://techberry.org/process.shout.php"><img height="80" width="80" title="<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
" alt="<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
" src="<?php echo $_smarty_tpl->tpl_vars['avatar']->value;?>
"><textarea id="shoutmsg" name="shoutmsg"></textarea><input type="submit" class="<?php echo $_smarty_tpl->getConfigVariable('prefixChat');?>
submit"/><div class="<?php echo $_smarty_tpl->getConfigVariable('prefixGlobal');?>
logo"></div><input type="hidden" name="token" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" onclick="return shout()"/></form></div></div></div><?php if (!$_smarty_tpl->tpl_vars['disableFooter']->value) {?><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['toTopButton']->value) {?><a id="toTop" href="#top" style="display:inline"><img width="40" height="40" src="http://techberry.org/images/to-top.png"></a><?php }?><script type="text/javascript">$(".shortened").shorten(),function(){$(function(){return $(".age.now").attr("datetime",new Date),$(".age.default").age(),$(".age.tiny").age({style:"tiny"}),$(".age.expired").age({expired:"expired"}),$(".age.pending").age({pending:"pending"})})}.call(this);</script><script type="text/javascript">
			$(document).ready(function(){$(".loadMore").click(function(){var e=this;if($(e).attr("data-first")){var t=$(e).attr("data-first")}else{var t=0}$.get("http://techberry.org/ajax/loadMore.php?info="+$(e).attr("data-info")+"&from="+$(e).attr("data-from")+"&first="+t,function(t){if(t=="false"){$("#contentList").append('<h2 class="endOfTheLine" style="text-align:center;margin-top:5px">End of the line</h2>');$(e).remove()}else{$(e).attr("data-from",parseInt($(e).attr("data-from"))+parseInt(20));$(e).attr("data-first",0);$("#contentList").append(t)}})}),$(".pointsNeeded").click(function(e){var t=$(this).attr("data-action");$.get("http://techberry.org/ajax/actions.php?action="+t,function(e){if(e=="-"){createAlert("error","Must be logged in to an active account"),$(this).attr("onclick","createAlert('error','Must be logged in to an active account')")}else if(e=="|"){createAlert("error","Locking is a permanent action"),$(this).attr("onclick","createAlert('error','Locking is a permanent action')")}else{createAlert("error","Requires "+e+" points"),$(this).attr("onclick","createAlert('error','Requires "+e+" points')")}}),e.preventDefault()})})
			$("body").htmlfeedback();
