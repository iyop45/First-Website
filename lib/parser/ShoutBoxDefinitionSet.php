 ...
 * @author jbowens
 */
class ShoutBoxDefinitionSet implements CodeDefinitionSet
{
    ...
    public function __construct()
    {
		...
		$mathJAXID = uniqid('mathjax_');
		$builder = new CodeDefinitionBuilder('math', '<script type="text/javascript">var math = document.getElementById("'.$mathJAXID.'");MathJax.Hub.Queue(["Typeset",MathJax.Hub,math]);</script>
																	<span id="'.$mathJAXID.'">\({param}\)</span>');
		array_push($this->definitions, $builder->build());
		/* [maths] mathematics tag */
		$mathJAXID = uniqid('mathjax_');
		$builder = new CodeDefinitionBuilder('maths', '<script type="text/javascript">var math = document.getElementById("'.$mathJAXID.'");MathJax.Hub.Queue(["Typeset",MathJax.Hub,math]);</script>
																	<span id="'.$mathJAXID.'">\({param}\)</span>');
		array_push($this->definitions, $builder->build());
