...
require_once 'TutorialDefinitionSet.php';
require_once 'ForumDefinitionSet.php';
require_once 'wallPostsDefinitionSet.php';
require_once 'ShoutBoxDefinitionSet.php';
require_once 'InstantMessengerDefinitionSet.php';
require_once 'QuestionsDefinitionSet.php';
...
class youtube extends CodeDefinition {
    ...
    public function asHtml(ElementNode $el)
    {
        ...
        $foundMatch = preg_match('/[a-zA-Z0-9_-]{11}/i', $content, $matches);
        if(!$foundMatch)
...
class left extends CodeDefinition {
 
    public function __construct()
    {
        parent::__construct();
        $this->setTagName("left");
    }
...
class center extends CodeDefinition {
 
    public function __construct()
    {
        parent::__construct();
        $this->setTagName("center");
    }
...
class right extends CodeDefinition {
 
    public function __construct()
    {
        parent::__construct();
        $this->setTagName("right");
    }
...
class justify extends CodeDefinition {
 
    public function __construct()
    {
        parent::__construct();
        $this->setTagName("justify");
    }
...
class sub extends CodeDefinition {
...
class sup extends CodeDefinition {
...
class s extends CodeDefinition {
...
class rtl extends CodeDefinition {
...
class ltr extends CodeDefinition {
    ...
    public function asHtml(ElementNode $el)
    {
        ...
        return '<p dir="ltr">'.$content.'</p>';
    }
}

class b extends CodeDefinition {
...
class i extends CodeDefinition {
...
class u extends CodeDefinition {
