...
if($c->isLoggedIn){
	if(!$c->p->hasPermission('view_statisticsOneview')){
...
<div id="menu">
 <ul>
  ...
  <div class="middle">
    <h3>One View</h3>
	<table width="100%" border="0" cellpadding="5" cellspacing="0" class="oneview valign">
      <tr valign="top">
      <?PHP
  ...
  <div class="middle">
    <h3>Last 24 hours </h3>
	<table height="200" width="100%" cellpadding="0" cellspacing="0" align="right" class="valign">
  ...
  <div class="full">
    <h3>Last 30 days </h3>
	<table height="230" width="100%" cellpadding="0" cellspacing="0" align="right" class="valign">
