...
class HtmlReporter extends SimpleReporter {
    ...
    function paintHeader($test_name) {
		...
		print "<style type=\"text/css\">".$this->getCss()."</style>";
        flush();
    }
    ...
    protected function getCss() {
        return ".fail { background-color: inherit; color: red; font-size: 12px; font-weight: bold; }" .
                ".pass { background-color: inherit; color: green; font-size: 12px; font-weight: bold; }" .
                ".__text { 
							color: #444;
							font-size: 12px;
                ...
                " pre { background-color: lightgray; color: inherit; font-size: 12px; font-weight: bold; }";
    }
