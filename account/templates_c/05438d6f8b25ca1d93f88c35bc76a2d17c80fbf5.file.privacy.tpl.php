<?php /* Smarty version Smarty-3.1.16, created on 2014-02-11 06:47:54
         compiled from "/home/content/99/11499199/html/account/templates/privacy.tpl" */ ?>
<?php /*%%SmartyHeaderCode:213200505052fa2a0a45ea22-13118229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05438d6f8b25ca1d93f88c35bc76a2d17c80fbf5' => 
    array (
      0 => '/home/content/99/11499199/html/account/templates/privacy.tpl',
      1 => 1392126419,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '213200505052fa2a0a45ea22-13118229',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52fa2a0a69db61_83022249',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52fa2a0a69db61_83022249')) {function content_52fa2a0a69db61_83022249($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config('/home/content/99/11499199/html/templates/config/css.prefix.conf', $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
...
tab_default<?php }?>">Account</li></a><a href="http://techberry.org/account/personalise/" id="personalise_link" class="side_anchor"><li class="<?php if ($_smarty_tpl->tpl_vars['accountPersonaliseTab']->value) {?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_active<?php } else { ?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_default<?php }?>">Personalise</li></a><a href="http://techberry.org/account/notifications/" id="notifications_link" class="side_anchor"><li class="<?php if ($_smarty_tpl->tpl_vars['accountNotificationsTab']->value) {?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_active<?php } else { ?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
...
tab_active<?php } else { ?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_default<?php }?>">Achievements</li></a><a href="http://techberry.org/account/privacy/" id="privacy_link" class="side_anchor"><li class="<?php if ($_smarty_tpl->tpl_vars['accountPrivacyTab']->value) {?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_active<?php } else { ?><?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
tab_default<?php }?>">Privacy</li></a></ul></div><div id="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
side_content"><h3><p>Your privacy settings</p></h3><form id="form" action="update.php" method="POST"><table class="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
edit"><tr><td><input value="1" class="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
check" id="prvt_general" name="prvt_general" type="checkbox" '; if($p_1==1){ echo ' checked '; } echo '></td><td><label title="Such as your ip address, browsing activity etc" for="prvt_general">Enable emoticons</label></td></tr><tr><td><input value="1" class="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
check" id="prvt_encrypt" name="prvt_encrypt" type="checkbox"></td><td><label for="prvt_encrypt">Recieve email updates on new notifications</label></td></tr><tr><td><input value="1" class="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
check" id="prvt_security" name="prvt_security" type="checkbox" '; if($p_3==1){ echo ' checked '; } echo '></td><td><label for="prvt_security">Recieve emails regarding updates and your account security</label></td></tr><tr><td><input value="1" class="<?php echo $_smarty_tpl->getConfigVariable('prefixAccount');?>
check" id="prvt_log" name="prvt_log" type="checkbox" '; if($p_4==1){ echo ' checked '; } echo '></td><td><label for="prvt_log">Enable logins through different ip addresses</label></td></tr><tr><td><input id="fkey" name="fkey" type="hidden" value="' . $fkey . '"/><input name="prvcy" type="hidden" value="1"/><input class="blue" type="submit" name="save" value="save"></td></tr></table></form></div></div></div></div><?php echo $_smarty_tpl->getSubTemplate ("/home/content/99/11499199/html/templates/core/footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
